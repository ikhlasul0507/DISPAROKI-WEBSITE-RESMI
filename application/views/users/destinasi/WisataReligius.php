<div class="header justify-content-center">
    <h4 class="text-center">Persebaran Wisata Religius Di Kabupaten Ogan Komering Ilir</h4>
</div>
...
<style type="text/css">
   ...
   <script type="text/javascript">
    ...
    <?php foreach ($data_wstr as $key => $value){?>
    ...
    <div class="popular_places_area">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="row">
                       <?php foreach ($data_wstr as $wr):?>
                         <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                <div class="thumb">
                                    <img style="width: 500px;height: 200px" src="<?= base_url();?>assets/admin/img/master_wisata/<?= $wr->photo_wisata;?>" alt="">
                                </div>
                                <div class="place_info">
                                    <a href="<?= base_url()?>WisataReligius/detail/<?= $wr->id_master_wisata;?>"><h3><?= $wr->nama_master_wisata;?></h3></a>
                                    <p><?= $wr->nama_kecamatan;?></p>
                                    <div class="rating_days d-flex justify-content-between">
                                        ...
                                        <div class="days">
                                            ...
                                            <a href="<?= base_url()?>WisataReligius/detail/<?= $wr->id_master_wisata;?>">Admin</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
