<div class="header justify-content-center" style="background: linear-gradient(#ff4d21,   #edff21);">
    <h4 class="text-center">Persebaran Wisata Kuliner Di Kabupaten Kota Pagaralam</h4>
</div>
                       ...
                       <?php if ($data_wcari){?>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                <a href="<?= base_url()?>WisataKuliner/detail/<?= $wsa->id_master_wisata;?>">
                                <div class="thumb">
                                    <img style="width: 500px;height: 200px" src="<?= base_url();?>assets/admin/img/master_wisata/<?= $wsa->photo_wisata;?>" alt="">
                                </div>
                                </a>
                                <div class="place_info">
                                    <a href="<?= base_url()?>WisataKuliner/detail/<?= $wsa->id_master_wisata;?>"><h3><?= $wsa->nama_master_wisata;?></h3></a>
                                    ...
                                    <div class="rating_days d-flex justify-content-between">
                                        ...
                                        <div class="days">
                                            ...
                                            <a href="<?= base_url()?>WisataKuliner/detail/<?= $wsa->id_master_wisata;?>">Admin</a>
                                        </div>
                                    </div>
                                </div>
