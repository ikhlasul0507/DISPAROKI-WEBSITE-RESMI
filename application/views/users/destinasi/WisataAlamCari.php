<div class="header justify-content-center" style="background: linear-gradient(#00BFFF,   #87CEFA);">
    <h4 class="text-center">Persebaran Wisata Alam Di Kabupaten Ogan Komering Ilir</h4>
</div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="filter_result_wrap">
                        ...
                        <form method="post" action="<?= base_url();?>WisataAlam/cari">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                <a href="<?= base_url()?>WisataAlam/detail/<?= $wsa->id_master_wisata;?>">
                                <div class="thumb">
                                    <img style="width: 500px;height: 200px" src="<?= base_url();?>assets/admin/img/master_wisata/<?= $wsa->photo_wisata;?>" alt="">
                                </div>
                                </a>
                                <div class="place_info">
                                    <a href="<?= base_url()?>WisataAlam/detail/<?= $wsa->id_master_wisata;?>"><h3><?= $wsa->nama_master_wisata;?></h3></a>
                                    ...
                                    <div class="rating_days d-flex justify-content-between">
                                        ...
                                        <div class="days">
                                            ...
                                            <a href="<?= base_url()?>WisataAlam/detail/<?= $wsa->id_master_wisata;?>">Admin</a>
                                        </div>
                                    </div>
                                </div>
