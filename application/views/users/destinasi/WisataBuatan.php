...
<style type="text/css">
   ...
   <script type="text/javascript">
    ...
    <?php foreach ($data_wstb as $key => $value){?>
    ...
    <div class="popular_places_area" style="background: linear-gradient(#00BFFF,   #87CEFA);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="row">
                       <?php foreach ($data_wstb as $wb):?>
                         <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                <div class="thumb">
                                    <img style="width: 500px;height: 200px" src="<?= base_url();?>assets/admin/img/master_wisata/<?= $wb->photo_wisata;?>" alt="">
                                </div>
                                <div class="place_info">
                                    <a href="<?= base_url()?>WisataBuatan/detail/<?= $wb->id_master_wisata;?>"><h3><?= $wb->nama_master_wisata;?></h3></a>
                                    <p><?= $wb->nama_kecamatan;?></p>
                                    <div class="rating_days d-flex justify-content-between">
                                        ...
                                        <div class="days">
                                            ...
                                            <a href="<?= base_url()?>WisataBuatan/detail/<?= $wb->id_master_wisata;?>">Admin</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
