<div class="header justify-content-center" style="background: linear-gradient(#00BFFF,   #87CEFA);">
    <h4 class="text-center">Persebaran Restoran Di Kabupaten Ogan Komering Ilir</h4>
</div>
...
<style type="text/css">
   ...
   <script type="text/javascript">
    ...
    <?php foreach ($data_srnht as $key => $value){?>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="filter_result_wrap">
                        ...
                        <form method="post" action="<?= base_url();?>Restoran/cari">
                ...
                <div class="col-lg-8">
                    <div class="row">
                    <?php if ($data_srnht){?>
                    <?php foreach ($data_srnht as $dm):?>
                     <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                <a href="<?= base_url();?>Restoran/detail/<?= $dm->id_sarana ?>">
                                <div class="thumb">
                                    <img style="width: 500px;height: 200px" src="<?= base_url();?>assets/admin/img/master_sarana/<?= $dm->photo_sarana;?>" alt="">
                                </div>
                                </a>
                                <div class="place_info">
                                    <a href="<?= base_url();?>Restoran/detail/<?= $dm->id_sarana ?>"><h3><?= $dm->nama_master_sarana;?></h3></a>
                                    ...
                                    <div class="rating_days d-flex justify-content-between">
                                        <span class="d-flex justify-content-center align-items-center">
                                             ...
                                             <i class="fa fa-star"></i> 
                                             <i class="fa fa-star"></i>
                                             <a href="<?= base_url();?>Restoran/detail/<?= $dm->id_sarana ?>">Selengkapnya</a>
                                        </span>
                                        <div class="days">
                                            <i class="fa fa-clock-o"></i>
                                            <a href="<?= base_url();?>Restoran/detail/<?= $dm->id_sarana ?>">Admin</a>
                                        </div>
                                    </div>
                                </div>
