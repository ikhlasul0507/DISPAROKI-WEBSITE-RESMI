                ...
                <div class="col-lg-12 col-md-9">
                    ...
                    <div class="destination_info">
                         ...
                         <ul class="list-group">
                          ...
                          <li class="list-group-item"><i class="fa fa-credit-card"></i> || <?= $ds->nama_master_budaya; ?></li>
                          <li class="list-group-item"><i class="fa fa-map"></i> || <?= $ds->nama_desa; ?>, <?= $ds->nama_kecamatan; ?></li>
                          <li class="list-group-item">
                            <h4>Deskripsi <?= $ds->nama_master_budaya; ?></h4>
                            <div class="row">
                                <div class="col">
                                   <img style="width: 350px;height: 200px" src="<?= base_url();?>assets/admin/img/master_budaya/<?= $ds->photo_budaya;?>" alt="">
                                </div>
                                <div class="col">
                                    <p><?= $ds->deskripsi_budaya1;?>.</p>
                                </div>
                            </div>
                           
                            <div class="single_destination">
                               
                                <p><?= $ds->deskripsi_budaya2;?>.</p>
                            </div>
                            <div class="single_destination">
                        
                                <p><?= $ds->deskripsi_budaya3;?>.</p>
                            </div>
                          ...
                          <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <h5>Bagikan</h5>
                                    <a rel='nofollow' href="javascript:void(0);" onclick="popUp=window.open('https://www.facebook.com/sharer.php?u=<?= base_url();?><?= $this->uri->segment(1); ?>/detail/<?= $ds->id_master_budaya; ?>')"><img src='http://syam.eu.org/icon/fb.jpg' alt='' width='25' height='25'></a>

                                    <a rel='nofollow' href="javascript:void(0);" onclick="popUp=window.open('https://plus.google.com/share?url=<?= base_url();?><?= $this->uri->segment(1); ?>/detail/<?= $ds->id_master_budaya; ?>');">
                                    <img src='http://syam.eu.org/icon/g.jpg' alt='' width='25' height='25'></a>

                                    <a rel='nofollow' href="javascript:void(0);" onclick="popUp=window.open('http://www.linkedin.com/shareArticle?mini=true&url=<?= base_url();?><?= $this->uri->segment(1); ?>/detail/<?= $ds->id_master_budaya; ?>');">
                                    <img src='http://syam.eu.org/icon/in.jpg' alt='' width='25' height='25'></a> 

                                    <a rel='nofollow' href="javascript:void(0);" onclick="popUp=window.open('https://twitter.com/share?url=<?= base_url();?><?= $this->uri->segment(1); ?>/detail/<?= $ds->id_master_budaya; ?>');">
                                    <img src='http://syam.eu.org/icon/tw.jpg' alt='' width='25' height='25'></a>

                                    <a rel='nofollow' href="javascript:void(0);" onclick="popUp=window.open('http://pinterest.com/pin/create/button/?url=<?= base_url();?><?= $this->uri->segment(1); ?>/detail/<?= $ds->id_master_budaya; ?>');" >
                                    <img src='http://syam.eu.org/icon/p.jpg' alt='' width='25' height='25'></a> 

                                    <a rel='nofollow' href="javascript:void(0);" onclick="popUp=window.open('whatsapp://send?text=<?= base_url();?><?= $this->uri->segment(1); ?>/detail/<?= $ds->id_master_budaya; ?>');">
                                    <img src='http://syam.eu.org/icon/wa.jpg' alt='' width='25' height='25'></a>

                                    <a rel='nofollow' href="javascript:void(0);" onclick="popUp=window.open('mailto:?Subject=&Body=<?= base_url();?><?= $this->uri->segment(1); ?>/detail/<?= $ds->id_master_budaya; ?>');"><img src='http://syam.eu.org/icon/em.jpg' alt='' width='25' height='25'></a>

                                 </ul>
                            </div>
                        </div>
                        <a href="<?= base_url('home/Qrcodebud/'.$ds->id_master_budaya);?>" target="blank">
...
<style type="text/css">
 ...
 //set icon untuk marker
    ...
    <?php foreach ($data_bdy as $key => $value){?>
