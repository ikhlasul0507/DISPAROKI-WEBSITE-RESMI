...
<style type="text/css">
   ...
   //set icon untuk marker
    ...
    <?php foreach ($data_bdytr as $key => $value){?>
            ...
            <div class="row">
                <div class="col-lg-4">
                     <div class="filter_result_wrap">
                        ...
                        <form method="post" action="<?= base_url();?>TradisiLisan/cari">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <?php if ($data_bdytr){?>
                        <?php foreach ($data_bdytr as $ds):?>
                        <div class="col-lg-6 col-md-6">
                            <div class="single_place">
                                <a href="<?= base_url();?>TradisiLisan/detail/<?= $ds->id_master_budaya; ?>">
                                <div class="thumb">
                                    <img style="width: 500px;height: 200px" src="<?= base_url();?>assets/admin/img/master_budaya/<?= $ds->photo_budaya;?>" alt="">
                                </div>
                                </a>
                                <div class="place_info">
                                    <a href="<?= base_url();?>TradisiLisan/detail/<?= $ds->id_master_budaya;?>"><h3><?= $ds->nama_master_budaya;?></h3></a>
                                    ...
                                    <div class="rating_days d-flex justify-content-between">
                                        <span class="d-flex justify-content-center align-items-center">
                                             ...
                                             <i class="fa fa-star"></i> 
                                             <i class="fa fa-star"></i>
                                             <a href="<?= base_url();?>TradisiLisan/detail/<?= $ds->id_master_budaya;?>">Selengkapnya</a>
                                        </span>
                                        <div class="days">
                                            <i class="fa fa-clock-o"></i>
                                            <a href="<?= base_url();?>TradisiLisan/detail/<?= $ds->id_master_budaya; ?>">Admin</a>
                                        </div>
                                    </div>
                                </div>
