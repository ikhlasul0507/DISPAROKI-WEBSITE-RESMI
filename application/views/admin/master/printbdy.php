...
<body background="<?= base_url();?>assets/users/gambar/logo.jpg" style="width: auto; height: auto">
  ...
  <div class="row">
    ...
    <hr>
	<!-- konten -->
  <?php foreach ($data_bdy as $sn): ?>
   <div class="box box-primary">
            <div class="box-body box-profile">
              <img  style="width: 100%" src="<?= base_url();?>assets/admin/img/master_budaya/<?= $sn->photo_budaya;?>">
              <h3 class="profile-username"><b><?= $sn->nama_master_budaya; ?></b></h3>

              <p class="text-muted"><small>Alamat : <?= $sn->nama_desa.''.$sn->nama_kecamatan;?></small></p>
              <p align="left"><?= $sn->deskripsi_budaya1; ?></p>
              <p align="left"><?= $sn->deskripsi_budaya2; ?></p>
              <p align="left"><?= $sn->deskripsi_budaya3; ?></p>
              <div class="row">
                <div class="col-xs-6">
