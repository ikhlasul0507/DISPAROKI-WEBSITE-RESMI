...
<body background="<?= base_url();?>assets/users/gambar/logo.jpg" style="width: auto; height: auto">
  ...
  <div class="row">
    ...
    <div class="col-xs-8">
      <h3 class="box-title" style="background-color: white">Data Sarana Kabupaten Ogan Komering Ilir<br>Dinas Pariwisata Dan Kebudayaan</h3>
    </div>
  </div>
    <hr>
	<!-- konten -->
  <?php foreach ($data_srn as $sn): ?>
   <div class="box box-primary">
            <div class="box-body box-profile">
              <img  style="width: 100%" src="<?= base_url();?>assets/admin/img/master_sarana/<?= $sn->photo_sarana;?>">
              <h3 class="profile-username"><b><?= $sn->nama_master_sarana; ?></b></h3>

              <p class="text-muted"><small>Alamat : <?= $sn->nama_desa.''.$sn->nama_kecamatan;?></small></p>
              <p align="left"><?= $sn->deskripsi_sarana1; ?></p>
              <p align="left"><?= $sn->deskripsi_sarana2; ?></p>
              <p align="left"><?= $sn->deskripsi_sarana3; ?></p>
              <div class="row">
                <div class="col-xs-6">
