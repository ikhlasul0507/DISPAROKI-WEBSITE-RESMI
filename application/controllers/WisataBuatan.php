...
class WisataBuatan extends CI_Controller {

	public function index()
	{
		$data['title']= "Destinasi Wisata Buatan";
		...
		$data['data_wstb']= $this->Model_user->listwstb();
		...
		$this->load->view('users/destinasi/WisataBuatan',$data);
	...
	public function cari()
	{
		...
		$data['data_brtg']= $this->Model_user->listbrtg();
		$data['data_kec']= $this->Model_user->listkec();
		$data['data_wcari'] = $this->Model_user->cariAllwisataBuatan($cari);
		$data['peta'] = $this->db->get('tbl_peta')->row_array();
		$this->load->view('users/temp/header',$data);
		$this->load->view('users/temp/head',$data);
		$this->load->view('users/destinasi/WisataBuatanCari',$data);
		$this->load->view('users/temp/foot',$data);
		$this->load->view('users/temp/footer');
	}
