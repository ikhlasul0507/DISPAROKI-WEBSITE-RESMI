...
class WisataAlam extends CI_Controller {

	public function index()
	{
		$data['title']= "Destinasi Wisata Alam";
		...
		$data['data_wsta']= $this->Model_user->listwsta();
		...
		$this->load->view('users/destinasi/WisataAlam',$data);
	...
	public function cari()
	{
		...
		//$data['data_wsta']= $this->Model_user->listwsta();
		$data['data_kec']= $this->Model_user->listkec();
		$data['data_wcari'] = $this->Model_user->cariAllwisata($cari);
		$data['peta'] = $this->db->get('tbl_peta')->row_array();
		$this->load->view('users/temp/header',$data);
		$this->load->view('users/temp/head',$data);
		$this->load->view('users/destinasi/WisataAlamCari',$data);
		$this->load->view('users/temp/foot',$data);
		$this->load->view('users/temp/footer');
	}
}
