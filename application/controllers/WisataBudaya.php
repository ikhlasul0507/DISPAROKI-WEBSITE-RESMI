...
class WisataBudaya extends CI_Controller {

	public function index()
	{
		$data['title']= "Destinasi Wisata Budaya";
		...
		$data['data_wstd']= $this->Model_user->listwstd();
		...
		$this->load->view('users/destinasi/WisataBudaya');
	...
	public function cari()
	{
		...
		$data['data_brtg']= $this->Model_user->listbrtg();
		$data['data_kec']= $this->Model_user->listkec();
		$data['data_wcari'] = $this->Model_user->cariAllwisataBudaya($cari);
		$data['peta'] = $this->db->get('tbl_peta')->row_array();
		$this->load->view('users/temp/header',$data);
		$this->load->view('users/temp/head',$data);
		$this->load->view('users/destinasi/WisataBudayaCari',$data);
		$this->load->view('users/temp/foot',$data);
		$this->load->view('users/temp/footer');
	}
}
